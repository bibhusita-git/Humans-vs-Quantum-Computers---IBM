...
class Level:
    ...
    def vertical_movement_collision(self):
        ...
        if player.on_ground and player.direction.y < 0 or player.direction.y > 1: # when player is jumping
            player.on_ground = False
        if player.on_ceiling and player.direction.y > 0.1: # when player is falling
